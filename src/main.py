...
class UI(ft.ResponsiveRow):
    def __init__(self, page):
        ...
        self.ven_SanAntonio = ce.create_textfield_planeador(hint_Text="Salma", hint_Style=ft.TextStyle(color="black", size=14, weight=ft.FontWeight.BOLD), text_Style=ft.TextStyle(color="black", size=14, weight=ft.FontWeight.BOLD))
        ...
        self.cdo_1 = ce.create_textfield_planeador(hint_Text="Ahidet", hint_Style=ft.TextStyle(color="black", size=14, weight="bold"), text_Style=ft.TextStyle(color="black", size=14, weight=ft.FontWeight.BOLD))
        self.cdo_2 = ce.create_textfield_planeador(hint_Text="Mishelle", hint_Style=ft.TextStyle(color="black", size=14, weight="bold"), text_Style=ft.TextStyle(color="black", size=14, weight=ft.FontWeight.BOLD))
        ...
        self.vm_Cofradia2 = ce.create_textfield_planeador(hint_Text="---", hint_Style=ft.TextStyle(color="black", size=14, weight="bold"), text_Style=ft.TextStyle(color="black", size=14, weight=ft.FontWeight.BOLD))
        ...
        self.total_vmg = ce.create_textfield_totales(text_Size=15, Width=50, Height=20, content_Padding=ft.padding.only(left=3, bottom=2, right=0, top=0))
        ...
        self.total_T5 = ce.create_textfield_totales(text_Size=14, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=1, right=0, top=0))
        self.total_T10 = ce.create_textfield_totales(text_Size=14, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=1, right=0, top=0))
        self.total_TT = ce.create_textfield_totales(text_Size=20, Width=45, Height=50, content_Padding=ft.padding.only(left=5, bottom=2.5, right=0, top=0), prefix_Text="$", prefix_Style=ft.TextStyle(color="#000000", size=18, weight="bold"))

        # --- Servicios a domicilio ---

        self.total_SD20 = ce.create_textfield_totales(text_Size=14, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=1, right=0, top=0))
        self.total_SD35 = ce.create_textfield_totales(text_Size=14, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=1, right=0, top=0))
        self.total_SD = ce.create_textfield_totales(text_Size=20, Width=50, Height=50, content_Padding=ft.padding.only(left=5, bottom=2.5, right=0, top=0), prefix_Text="$", prefix_Style=ft.TextStyle(color="#000000", size=18, weight="bold"))

        # --- Transferencias ---

        self.total_nTR = ce.create_textfield_totales(text_Size=16, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=4.5, right=0, top=0))
        self.total_mTR = ce.create_textfield_totales(text_Size=20, Width=80, Height=50, content_Padding=ft.padding.only(left=2, bottom=2, right=0, top=0), prefix_Text="$", prefix_Style=ft.TextStyle(color="#000000", size=18, weight="bold"))

        # --- Gastos | Retiros ---

        self.total_nGR = ce.create_textfield_totales(text_Size=16, Width=40, Height=20, content_Padding=ft.padding.only(left=3, bottom=4, right=0, top=0))
        self.total_mGR = ce.create_textfield_totales(text_Size=20, Width=80, Height=50, content_Padding=ft.padding.only(left=2, bottom=2, right=0, top=0), prefix_Text="$", prefix_Style=ft.TextStyle(color="#000000", size=18, weight="bold"))
                                                                                                ...
                                                                                                ft.Column(
                                                                                                    ...
                                                                                                    controls=[
                                                                                                        ft.Container(
                                                                                                            ...
                                                                                                            # bgcolor="#00B112",
                                                                                                            bgcolor="#00DA16",
                                                                                                            content=ft.Text("Supervisor(a) de Personal PDV's", color="black", size=11, weight="bold")
                                                                                                        ),
                                                                                                        ft.Container(
                                                                                                            expand=True,
                                                                                                            alignment=ft.alignment.center_left,
                                                                                        ...
                                                                                        content=ft.ResponsiveRow(
                                                                                            ...
                                                                                            controls=[
                                                                                                ft.Container(
                                                                                                    ...
                                                                                                    alignment=ft.alignment.center,
                                                                                                    border=ft.border.all(color="black", width=.5),
                                                                                                    # content=ft.Text("Logística\ny Transporte", color="white",size=25)
                                                                                                    content=ft.Column(
                                                                                                        alignment=ft.MainAxisAlignment.CENTER,
                                                                                                        horizontal_alignment="center",
                                                                                                        spacing=0,
                                                                                                        controls=[
                                                                                                            ft.Text("Logística y", color="white",size=26),
                                                                                                            ft.Text("Transporte", color="white",size=26),
                                                                                                        ]
                                                                                                    )
                                                                                                ),
                                                                                                ft.Column(
                                                                                            ...
                                                                                            controls=[
                                                                                                ft.Container(
                                                                                                    ...
                                                                                                    content=ft.Column(
                                                                                                        ...
                                                                                                        spacing=-5,
                                                                                                        controls=[
                                                                                                            ft.Text("Centro de", color="white",size=28),
                                                                                                            ft.Text("Operaciones", color="white",size=28),
                                                                                                            # ft.Text("(CEDIS / CDO)", color="white",size=15),
                                                                                                        ]
                                                                                                    )
                                                                                                ),
                                                                                                ft.Column(
                                                        ...
                                                        content=ft.Column(
                                                            ...
                                                            controls=[
                                                                ft.Container(
                                                                    ...
                                                                    alignment=ft.alignment.center,
                                                                    content=ft.Text("TOPPINGS EXTRAS", size=18, color="#ff1765", weight="bold", style=ft.TextStyle(letter_spacing=5))
                                                                ),
                                                                ft.ResponsiveRow(
                                                                    alignment=ft.MainAxisAlignment.SPACE_AROUND,
                                                                    vertical_alignment="center",
                                                        ...
                                                        content=ft.Column(
                                                            ...
                                                            controls=[
                                                                ft.Container(
                                                                    margin=ft.margin.symmetric(horizontal=0, vertical=5),
                                                                    alignment=ft.alignment.center,
                                                                    content=ft.Text("SERVICIOS A DOMICILIO", size=18, color="#ff1765", weight="bold", style=ft.TextStyle(letter_spacing=5))
                                                                ),
                                                                ft.ResponsiveRow(
                                                                    alignment=ft.MainAxisAlignment.SPACE_AROUND,
                                                                    vertical_alignment="center",
                                                    ...
                                                    ft.Container(# Transferencias
                                                        ...
                                                        content=ft.Column(
                                                            ...
                                                            controls=[
                                                                ft.Container(
                                                                    alignment=ft.alignment.center,
                                                                    content=ft.Text("TRANSFERENCIAS", size=18, color="#ff1765", weight="bold", style=ft.TextStyle(letter_spacing=5))
                                                                ),
                                                                ft.ResponsiveRow(
                                                                    expand=True,
                                                                    controls=[
                                                    ...
                                                    ft.Container(# Gastos / Retiros
                                                        ...
                                                        content=ft.Column(
                                                            ...
                                                            controls=[
                                                                ft.Container(
                                                                    alignment=ft.alignment.center,
                                                                    content=ft.Text("GASTOS | RETIROS", size=16, color="#ff1765", weight="bold", style=ft.TextStyle(letter_spacing=5))
                                                                ),
                                                                ft.ResponsiveRow(
                                                                    expand=True,
                                                                    controls=[
                                                                            ...
                                                                            content=ft.Column(
                                                                                ...
                                                                                controls=[
                                                                                    ft.Container(
                                                                                        ...
                                                                                        # padding=2,
                                                                                        alignment=ft.alignment.center,
                                                                                        content=ft.Text("TOPPINGS", size=12, color="white", weight=ft.FontWeight.BOLD, italic=True, style=ft.TextStyle(letter_spacing=5)),
                                                                                    ),
                                                                                    ft.ResponsiveRow(
                                                                                        expand=80,
                                                                                        spacing=0,
                                                                                        ...
                                                                                        vertical_alignment="center",
                                                                                        controls=[
                                                                                            ft.Container(# Totales por precio de topping
                                                                                                col=5.5,
                                                                                                # bgcolor="yellow",
                                                                                                padding=5,
                                                                                                alignment=ft.alignment.center,
                                                                                                content=ft.ResponsiveRow(
                                                                                                    ...
                                                                                                    controls=[
                                                                                                        ft.Column(
                                                                                                            ...
                                                                                                            horizontal_alignment="center",
                                                                                                            controls=[
                                                                                                                ft.Text("T-5", size=14, color="black", weight="bold"),
                                                                                                                ft.Text("'$10'", size=14, color="black", weight="bold"),
                                                                                                            ]
                                                                                                        ),
                                                                                                        ft.Column(
                                                                                                            col=6,
                                                                                            ...
                                                                                            ft.Container(# Total general toppings
                                                                                                col=5.5,
                                                                                                alignment=ft.alignment.center,
                                                                                                padding=ft.padding.only(top=2),
                                                                                                # bgcolor="yellow",
                                                                                                    ...
                                                                                                    controls=[
                                                                                                        ft.Container(
                                                                                                            ...
                                                                                                            content=ft.Column(
                                                                                                                ...
                                                                                                                spacing=-2,
                                                                                                                controls=[
                                                                                                                    ft.Text("TOTAL", size=12, color="black", weight="bold", italic=True),
                                                                                                                    ft.Text("TOPPINGS", size=12, color="black", weight="bold", italic=True)
                                                                                                                ]
                                                                                                            )
                                                                                                        ),
                                                                                                        self.total_TT
                                                                            ...
                                                                            content=ft.Column(
                                                                                ...
                                                                                controls=[
                                                                                    ft.Container(
                                                                                        ...
                                                                                        # padding=2,
                                                                                        alignment=ft.alignment.center,
                                                                                        content=ft.Text("SERVICIOS A DOMICILIO", size=12, color="white", weight=ft.FontWeight.BOLD, italic=True, style=ft.TextStyle(letter_spacing=3)),
                                                                                    ),
                                                                                    ft.ResponsiveRow(
                                                                                        expand=80,
                                                                                        spacing=0,
                                                                                        ...
                                                                                        vertical_alignment="center",
                                                                                        controls=[
                                                                                            ft.Container(# Totales por separado de los servicios a domicilio
                                                                                                col=5.5,
                                                                                                # bgcolor="yellow",
                                                                                                padding=5,
                                                                                                alignment=ft.alignment.center,
                                                                                                content=ft.ResponsiveRow(
                                                                                                    ...
                                                                                                    controls=[
                                                                                                        ft.Column(
                                                                                                            ...
                                                                                                            horizontal_alignment="center",
                                                                                                            controls=[
                                                                                                                ft.Text("SD-20", size=14, color="black", weight="bold"),
                                                                                                                ft.Text("'$35'", size=14, color="black", weight="bold"),
                                                                                                            ]
                                                                                                        ),
                                                                                                        ft.Column(
                                                                                                            col=6,
                                                                                            ...
                                                                                            ft.Container(# Total general servicios a domicilio
                                                                                                col=5.5,
                                                                                                alignment=ft.alignment.center,
                                                                                                padding=ft.padding.only(top=2),
                                                                                                # bgcolor="yellow",
                                                                                                    ...
                                                                                                    controls=[
                                                                                                        ft.Container(
                                                                                                            ...
                                                                                                            content=ft.Column(
                                                                                                                ...
                                                                                                                controls=[
                                                                                                                    ft.Text("TOTAL", size=12, color="black", weight="bold", italic=True),
                                                                                                                    ft.Text("SERV A DOM", size=12, color="black", weight="bold", italic=True)
                                                                                                                ]
                                                                                                            )
                                                                                                        ),
                                                                                                        self.total_SD
                                                                                        ...
                                                                                        content=ft.Column(
                                                                                            ...
                                                                                            controls=[
                                                                                                ft.Container(
                                                                                                    ...
                                                                                                    # padding=2,
                                                                                                    alignment=ft.alignment.center,
                                                                                                    content=ft.Text("TRANSFERENCIAS", size=11, color="white", weight=ft.FontWeight.BOLD, italic=True, style=ft.TextStyle(letter_spacing=.5)),
                                                                                                ),
                                                                                                ft.Container(
                                                                                                    expand=80,
                                                                                                    alignment=ft.alignment.center,
                                                                                                    ...
                                                                                                    content=ft.Column(
                                                                                                        ...
                                                                                                        spacing=0,
                                                                                                        controls=[
                                                                                                            ft.ResponsiveRow( # Cantidad de transferencias
                                                                                                                alignment=ft.MainAxisAlignment.SPACE_EVENLY,
                                                                                                                vertical_alignment="center",
                                                                                                                controls=[
                                                                                                                    ft.Container(
                                                                                                                        col=5,
                                                                                                                        alignment=ft.alignment.center,
                                                                                                                        content=ft.Text("NO TR", size=11, color="black", weight="bold"),
                                                                                                                    ),
                                                                                                                    ft.Container(
                                                                                                                        col=7,
                                                                                                                        bgcolor="yellow",
                                                                                                                        ...
                                                                                                                        alignment=ft.alignment.center,
                                                                                                                        content=self.total_nTR,
                                                                                                                    ),
                                                                                                                ]
                                                                                                            ),
                                                                                                            ft.ResponsiveRow( # Total general transferencias
                                                                                                                alignment=ft.MainAxisAlignment.SPACE_EVENLY,
                                                                                                                vertical_alignment="center",
                                                                                                                controls=[
                                                                                                                    ft.Container(
                                                                                                                        ...
                                                                                                                        content=ft.Column(
                                                                                                                            ...
                                                                                                                            horizontal_alignment="center",
                                                                                                                            controls=[
                                                                                                                                ft.Text("TOTAL", size=11, color="black", weight="bold"),
                                                                                                                                ft.Text("TRANSF", size=11, color="black", weight="bold"),
                                                                                                                            ]
                                                                                                                        ),
                                                                                                                    ),
                                                                                                                    ft.Container(
                                                                                        ...
                                                                                        content=ft.Column(
                                                                                            ...
                                                                                            controls=[
                                                                                                ft.Container(
                                                                                                    ...
                                                                                                    # padding=2,
                                                                                                    alignment=ft.alignment.center,
                                                                                                    content=ft.Text("GASTOS | RETIROS", size=11, color="white", weight=ft.FontWeight.BOLD, italic=True, style=ft.TextStyle(letter_spacing=.5)),
                                                                                                ),
                                                                                                ft.Container(
                                                                                                    expand=80,
                                                                                                    alignment=ft.alignment.center,
                                                                                                    ...
                                                                                                    content=ft.Column(
                                                                                                        ...
                                                                                                        spacing=0,
                                                                                                        controls=[
                                                                                                            ft.ResponsiveRow( # Cantidad de gastos / retiros
                                                                                                                alignment=ft.MainAxisAlignment.SPACE_EVENLY,
                                                                                                                vertical_alignment="center",
                                                                                                                controls=[
                                                                                                                    ft.Container(
                                                                                                                        col=5,
                                                                                                                        alignment=ft.alignment.center,
                                                                                                                        content=ft.Text("NO G/R", size=11, color="black", weight="bold"),
                                                                                                                    ),
                                                                                                                    ft.Container(
                                                                                                                        col=7,
                                                                                                                        bgcolor="yellow",
                                                                                                                ...
                                                                                                                controls=[
                                                                                                                    ft.Container(
                                                                                                                        ...
                                                                                                                        content=ft.Column(
                                                                                                                            ...
                                                                                                                            controls=[
                                                                                                                                ft.Text("TOTAL", size=11, color="black", weight="bold"),
                                                                                                                                ft.Text("GT | RT", size=11, color="black", weight="bold"),
                                                                                                                            ]
                                                                                                                        ),
                                                                                                                    ),
                                                                                                                    ft.Container(
    ...
    def conversion_n_capture_vc(self, e):
        ...
        try:
            ...
            self.total_vc.value = self.vcven.value
    ...
    def conversion_n_capture_vi(self, e):
        ...
        try:
            ...
            self.total_vi.value = self.viven.value
    ...
    def conversion_n_capture_vm(self, e):
        ...
        try:
            ...
            self.total_vm.value = self.vmven.value
    ...
    def conversion_n_capture_vg(self, e):
        ...
        try:
            ...
            self.total_vg.value = self.vgven.value
    ...
    def conversion_n_capture_vmg(self, e):
        ...
        try:
            ...
            self.total_vmg.value = self.vmgven.value
    ...
    def conversion_n_capture_co(self, e):
        ...
        if all(co.value == "" for co in self.values_co):
            ...
            if self.cov.value == "" and self.cchv.value != "" and self.ccav.value != "":
                ...
                self.total_cremas.value = self.creven.value
                self.creven.update()
                self.total_cremas.update()
            ...
            if self.cof.value not in ("", "."):
                try:
                    ...
                    if abs(self.less_valuesCo - round(self.less_valuesCo)) < 1e-9: # Tolerancia (epsilon)
                        ...
                        self.total_or.value = self.cov.value
                    else:
                        # Mostrar como máximo 2 decimales
            ...
            if self.cchf.value not in ("", "."):
                try:
                    ...
                    if abs(self.less_valuesCch - round(self.less_valuesCch)) < 1e-9: # Tolerancia (epsilon)
                        ...
                        self.total_ch.value = self.cchv.value
                    else:
                        # Mostrar como máximo 2 decimales
            ...
            if self.ccaf.value not in ("", "."):
                try:
                    ...
                    if abs(self.less_valuesCca - round(self.less_valuesCca)) < 1e-9: # Tolerancia (epsilon)
                        ...
                        self.total_ca.value = self.ccav.value
                    else:
                        # Mostrar como máximo 2 decimales
    ...
    def reset_Fields(self, e):
        ...
        self.totales_BG = [self.total_vc, self.total_vi, self.total_vm, self.total_vg, self.total_vmg, self.total_vasos, self.total_fresa, self.total_uva, self.total_fruta, self.total_or, self.total_ch, self.total_ca, self.total_cremas]
        for element in self.totales_BG:
            element.value = ""
